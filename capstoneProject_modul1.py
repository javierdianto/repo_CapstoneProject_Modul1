...
def divisi(dataPegawai):
     divisiPegawai1 = input('Filter Data Berdasarkan Divisi :  ')
...
def jabatan(dataPegawai):
     jabatanPegawai1 = input('Filter Data Berdasarkan Jabatan :  ')
...
def domisili(dataPegawai):
     domisiliPegawai1 = input('Filter Data Berdasarkan Domisili :  ')
...
def UpdateDivisi(dataPegawai):
     ...
     for pegawai in dataPegawai:
           if pegawai ['idPegawai'] == idPegawaiInput:
            ...
            userInput = input('Lanjutkan Pengubahan Data? : ')
            if userInput == '1':
...
def dataPegawaiUpdated():
     ...
     if not dataSama:
          ...
          userInput = input('Lanjutkan Penambahan Pegawai? : ')
          if userInput == '1':
...
def HapusDataPegawai():
     ...
     for index, pegawai in enumerate(dataPegawai):
           if pegawai['idPegawai'] == idPegawaiInput:
                 ...
                 print('1. Ya')
                 print('0. Kembali ke halaman utama')
                 userInput = input('Lanjutkan Penghapusan Data? : ')
                 if userInput == '1':
...
while userInput != '5':
    ...
    if userInput == '1':
            ...
            if userMenu1 =='1':
                ...
                userSort = input('Pilih Data Filter: ')
                if userSort =='1':
                     divisi(dataPegawai)
